...
import 'package:pro_icon/Features/auth/register/widgets/address_form.dart';
      ...
      return BaseAppScaffold(
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              CustomAppBar(icon: Icons.arrow_back_ios, text: "Profile" , onIconPressed: (){
                ...
                children: [
                  Stack(
                    ...
                    children: [
                      ...
                      const CircleAvatar(
                        radius: 30,
                        child: Image(image: AssetImage("assets/images/userImage.png") ,fit: BoxFit.cover, width: 93,),
                      ),
