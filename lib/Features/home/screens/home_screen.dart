...
class HomeScreen extends StatefulWidget {
  ...
  class _HomeScreenState extends State<HomeScreen> {
    ...
    List Ctaegory = [
      {"name": "Power", "imageUrl": "assets/images/power.png"},
      {"name": "Cardio", "imageUrl": "assets/images/cardio.png"},
      {"name": "Lose Weight", "imageUrl": "assets/images/lose weight.png"},
      {"name": "Skin Fit", "imageUrl": "assets/images/skinfit.png"},
      {"name": "Flexibility", "imageUrl": "assets/images/Rectangle 15.png"},
      {"name": "Rehabilitation", "imageUrl": "assets/images/rehabilation.png"},
    ];
        ...
        child: BaseAppScaffold(
            ...
            children:   [
              ...
              const Align(
                ...
                child: Padding(
                  ...
                  child: Text("Choose a category to start with" , style: TextStyle(
                    color: Colors.white,
                    fontSize: 16
                  ),),
                ),
          ...
          SizedBox(
            ...
            child: BlocBuilder<HomeCubit , HomeState>(
              ...
              {
                if( state is CategoryError ) { return Text("${state.errorMessage}"); }
                             ...
                             child: Container(
                               ...
                               decoration: BoxDecoration(
                                 image: DecorationImage(
                                     image: NetworkImage("${currentCategory.image}")
                                 ),
                               ),
                             ),
                           ),
