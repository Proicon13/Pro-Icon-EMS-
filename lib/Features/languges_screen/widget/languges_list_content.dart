              ...
              Expanded(
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      leading: CustomSvgVisual(assetPath: "${flagSvg}"),
                      title: Text(
                        language,
                      ...
                      trailing: state.selectedLanguage == language
                          ? CustomSvgVisual(assetPath: Assets.assetsSelectedIcon)
                          : null,
                      onTap: () {
              ...
              if (state.selectedLanguage != null)
                CustomButton(onPressed: (){
                  showDialog(
                      ...
                      builder: (context)
                      {
                        return CustomConfirmationDialog(title: "Change Languages", confirmationTitle: "change Confirm", onConfirm: (){});
                      }
                  );
                }, text: "confirm".tr()),
