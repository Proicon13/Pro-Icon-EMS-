            ...
            child: Column(
              ...
              const    CustomHeader(titleKey: "Session Summary"),
                ...
                Align(
                  ...
                  child: Text("Session details" , style: AppTextStyles.fontSize16(context).copyWith(
                    color: Colors.grey
                  ),),
                ),
                context.setMinSize(25).verticalSpace,
                    ...
                    builder: (context) {
                      return Container(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                               CustomRectangularImage(width: context.setMinSize(81), height: context.setMinSize(79), imageUrl: Assets.assetsSessionSummaryImage ),
                              context.setMinSize(15).horizontalSpace,
                              Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("Automatic session" , style: AppTextStyles.fontSize16(context).copyWith(
                                    color: Colors.white
                                  ),),

                                  Row(
                                    children: [
                                      Text("HZ 80" , style: AppTextStyles.fontSize14(context).copyWith(
                                        color: Colors.white
                                      ),),
                                       context.setMinSize(10).horizontalSpace,
                                     const   CustomSvgVisual(assetPath: Assets.assetsImagesPulseIcon),
                                      context.setMinSize(10).horizontalSpace,
                                      Text("PU 550" , style: AppTextStyles.fontSize14(context).copyWith(
                                        color: Colors.white
                                      ),)
                                    ],
                                  ),
                                  ...
                                  Row(
                                    children: [
                                      Row(
                                        children: [
                                          CustomSvgVisual(assetPath: Assets.assetsImagesMadsIcon ,width: context.setMinSize(16), height: context.setMinSize(16),),
                                          context.setMinSize(10).horizontalSpace,
                                           Text("3 MADS" , style: AppTextStyles.fontSize14(context).copyWith(color: Colors.grey),)
                                        ],
                                      ),
                                      context.setMinSize(40).horizontalSpace,
                                      Row(
                                        children: [
                                        const   CustomSvgVisual(assetPath: Assets.assetsImagesDurationIcon),
                                          context.setMinSize(10).horizontalSpace,
                                           Text("15 Min" ,style: AppTextStyles.fontSize14(context).copyWith(color: Colors.grey))
                                        ],
                                      ),
                                    ],
                                  )
